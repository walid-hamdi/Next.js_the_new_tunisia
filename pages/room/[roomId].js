    ...
    <Layout>
      {!willingToConnect && (
        ...
        <div className="spacing willing-to-connect">
          ...
          <Heading size={1}>Please be responsible after you join because there are serious rules for bad people (BE POLITE , BE ACTIVE)</Heading>
          ...
          <div >
            ...
            <Button big onClick={joinRoom}>Join Now</Button>
          </div>
        </div>
